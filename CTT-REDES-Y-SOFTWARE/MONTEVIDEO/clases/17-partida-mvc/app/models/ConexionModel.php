...
class ConexionModel {
    ...
    private static $instancia = null; // Aquí almacenaremos la única instancia de la clase (Singleton)
    private $conexion;

    // Constructor privado para evitar la creación directa de la clase desde fuera
    // A diferencia de otras veces, nunca vamos a crear un objeto de esta clase
